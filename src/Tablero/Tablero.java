...
public class Tablero {
    ...
    private boolean bus;
    /**
     * En este constructor se va inicializan datos y se llena la matriz casilla.
     */
    public Tablero() {
     ...
     * @return Color turno: El color ya sea blanco o negro.
     * Casilla casilla: La casilla con todos sus atributos.
     */
    @Override
